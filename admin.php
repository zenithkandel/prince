<<i class="fa-solid fa-scissors"></i>php
...
$tab = isset($_GET['tab']) <i class="fa-solid fa-scissors"></i> $_GET['tab'] : 'general';
$success = isset($_GET['success']) <i class="fa-solid fa-scissors"></i> htmlspecialchars($_GET['success']) : null;
...
<body class="bg-[#f0f0f0] font-sans flex flex-col md:flex-row min-h-screen selection:bg-yellow-300">
    ...
    <aside
        ...
        <div class="px-6 mb-10">
            <a href="<i class="fa-solid fa-scissors"></i>tab=general" class="block hover:-translate-y-1 transition-transform">
        ...
        <nav class="flex-grow flex flex-col px-4 gap-4 pb-4">
            <a href="<i class="fa-solid fa-scissors"></i>tab=general"
                class="font-bold border-4 border-black p-3 brutal-shadow uppercase flex justify-between items-center <<i class="fa-solid fa-scissors"></i>php echo $tab === 'general' <i class="fa-solid fa-scissors"></i> 'bg-yellow-300 transform translate-x-2 scale-[1.02]' : 'bg-gray-50 hover:bg-yellow-100 hover:translate-x-1 transition-all'; <i class="fa-solid fa-scissors"></i>>">
                <span>General Stats</span> <span class="text-xl"><i class="fa-solid fa-house"></i></span>
            </a>
            <a href="<i class="fa-solid fa-scissors"></i>tab=music"
                class="font-bold border-4 border-black p-3 brutal-shadow uppercase flex justify-between items-center <<i class="fa-solid fa-scissors"></i>php echo $tab === 'music' <i class="fa-solid fa-scissors"></i> 'bg-[#00e5ff] transform translate-x-2 scale-[1.02]' : 'bg-gray-50 hover:bg-cyan-100 hover:translate-x-1 transition-all'; <i class="fa-solid fa-scissors"></i>>">
                <span>Music Config</span> <span class="text-xl"><i class="fa-solid fa-music"></i></span>
            </a>
            <a href="<i class="fa-solid fa-scissors"></i>tab=gallery"
                class="font-bold border-4 border-black p-3 brutal-shadow uppercase flex justify-between items-center <<i class="fa-solid fa-scissors"></i>php echo $tab === 'gallery' <i class="fa-solid fa-scissors"></i> 'bg-[#ff00ff] text-white transform translate-x-2 scale-[1.02]' : 'bg-gray-50 hover:bg-pink-100 hover:translate-x-1 transition-all text-black'; <i class="fa-solid fa-scissors"></i>>">
        ...
        <div class="p-6 mt-8 flex flex-col gap-3 pt-6 border-t-4 border-black border-dashed">
            ...
            <a href="<i class="fa-solid fa-scissors"></i>logout=1"
    ...
    <main class="flex-grow p-6 md:p-10 lg:p-14 overflow-y-auto relative z-10 w-full">
        ...
        <div class="max-w-5xl mx-auto">
            <<i class="fa-solid fa-scissors"></i>php if ($success): <i class="fa-solid fa-scissors"></i>>
                <div class="bg-green-400 border-[4px] border-black font-black p-4 mb-10 brutal-shadow text-xl uppercase transform -rotate-1 relative group w-full md:w-auto inline-flex items-center gap-3 animate-pulse cursor-pointer"
                    onclick="this.remove()">
                    <span><i class="fa-solid fa-check-circle"></i></span> <span><<i class="fa-solid fa-scissors"></i>php echo $success; <i class="fa-solid fa-scissors"></i>></span>
                    <div class="absolute -top-2 -right-2 w-4 h-4 bg-yellow-300 rounded-full border-2 border-black"></div>
                </div>
            <<i class="fa-solid fa-scissors"></i>php endif; <i class="fa-solid fa-scissors"></i>>

            <!-- TAB: GENERAL -->
            <<i class="fa-solid fa-scissors"></i>php if ($tab === 'general'): <i class="fa-solid fa-scissors"></i>>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 mt-8 relative z-0">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="hero[tag]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['hero']['tag']); <i class="fa-solid fa-scissors"></i>>"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="hero[location]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['hero']['location']); <i class="fa-solid fa-scissors"></i>>"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="hero[title_first]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['hero']['title_first']); <i class="fa-solid fa-scissors"></i>>"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="hero[title_last]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['hero']['title_last']); <i class="fa-solid fa-scissors"></i>>"
                                    class="border-[3px] border-black p-4 font-black text-2xl focus:outline-none focus:ring-[4px] focus:ring-yellow-300 transition-all bg-transparent focus:bg-white border-b-8">
                            </div>
                            <!-- Input Block -->
                            <div class="flex flex-col gap-2 md:col-span-2">
                                ...
                                <input type="text" name="hero[subtitle]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['hero']['subtitle']); <i class="fa-solid fa-scissors"></i>>"
                                    class="border-[3px] border-black p-4 font-mono text-base focus:outline-none focus:ring-[4px] focus:ring-yellow-300 transition-all bg-gray-50 focus:bg-white">
                            </div>
                            <!-- Input Block -->
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="hero[cta]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['hero']['cta'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <<i class="fa-solid fa-scissors"></i>php if (isset($data['hero']['img']) && $data['hero']['img']): <i class="fa-solid fa-scissors"></i>>
                                            <img src="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['hero']['img']); <i class="fa-solid fa-scissors"></i>>"
                                                class="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-300">
                                        <<i class="fa-solid fa-scissors"></i>php else: <i class="fa-solid fa-scissors"></i>>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 mt-8 relative z-0">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="about[title]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['about']['title']); <i class="fa-solid fa-scissors"></i>>"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="about[badge_text]"
                                    value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['about']['badge_text']); <i class="fa-solid fa-scissors"></i>>"
                            ...
                            <div class="flex flex-col gap-2 md:col-span-2">
                                ...
                                <textarea name="about[content_p1]" rows="5"
                                    class="border-[3px] border-black p-5 font-sans leading-relaxed text-base focus:outline-none focus:ring-[4px] focus:ring-cyan-400 transition-all bg-gray-50 focus:bg-white resize-y"><<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['about']['content_p1']); <i class="fa-solid fa-scissors"></i>></textarea>
                            </div>
                            <!-- Input Block -->
                            <div class="flex flex-col gap-2 md:col-span-2">
                                <label class="font-bold uppercase text-sm flex items-center justify-between">
                                ...
                                <textarea name="about[content_p2]" rows="5"
                                    class="border-[3px] border-black p-5 font-sans leading-relaxed text-base focus:outline-none focus:ring-[4px] focus:ring-cyan-400 transition-all bg-gray-50 focus:bg-white resize-y"><<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['about']['content_p2']); <i class="fa-solid fa-scissors"></i>></textarea>
                            </div>
                            <!-- Image Block -->
                            <div class="flex flex-col gap-2 md:col-span-2">
                                ...
                                <div
                                    ...
                                    <div
                                        class="w-16 h-16 md:w-20 md:h-20 border-2 border-black flex-shrink-0 bg-white overflow-hidden flex items-center justify-center brutal-shadow-sm">
                                        <<i class="fa-solid fa-scissors"></i>php if (isset($data['about']['img']) && $data['about']['img']): <i class="fa-solid fa-scissors"></i>>
                                            <img src="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($data['about']['img']); <i class="fa-solid fa-scissors"></i>>"
                                                class="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-300">
                                        <<i class="fa-solid fa-scissors"></i>php else: <i class="fa-solid fa-scissors"></i>>
                                            <span class="text-[10px] uppercase font-bold text-gray-400">None</span>
                                        <<i class="fa-solid fa-scissors"></i>php endif; <i class="fa-solid fa-scissors"></i>>
            ...
            <!-- TAB: MUSIC -->
            <<i class="fa-solid fa-scissors"></i>php if ($tab === 'music'): <i class="fa-solid fa-scissors"></i>>
                <div
                ...
                <form action="handler.php" method="POST" enctype="multipart/form-data" class="space-y-10">
                    ...
                    <<i class="fa-solid fa-scissors"></i>php if (empty($data['music']['releases'])): <i class="fa-solid fa-scissors"></i>>
                        <div
                    ...
                    <<i class="fa-solid fa-scissors"></i>php else: <i class="fa-solid fa-scissors"></i>>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-14">
                            <<i class="fa-solid fa-scissors"></i>php foreach ($data['music']['releases'] as $index => $item): <i class="fa-solid fa-scissors"></i>>
                                <div
                                    ...
                                    <div
                                        ...
                                        <span><i class="fa-solid fa-compact-disc"></i></span> Release #<<i class="fa-solid fa-scissors"></i>php echo $index + 1; <i class="fa-solid fa-scissors"></i>>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <<i class="fa-solid fa-scissors"></i>php if (!empty($item['img'])): <i class="fa-solid fa-scissors"></i>>
                                                <img src="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['img']); <i class="fa-solid fa-scissors"></i>>"
                                        ...
                                        <div class="flex-grow w-full overflow-hidden">
                                            <label
                                                ...
                                                Source</label>
                                            <input type="hidden" name="music_releases[<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>][existing_img]"
                                                value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['img'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>">
                                            <input type="file" name="music_img_<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>"
                                    ...
                                    <div class="flex flex-col gap-5 mt-2">
                                        <div class="flex flex-col gap-1.5 peer">
                                            <label class="font-bold uppercase text-[10px] text-gray-400 tracking-widest">Release
                                                Title</label>
                                            <input type="text" name="music_releases[<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>][title]"
                                                value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['title'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>"
                                        ...
                                        <div class="flex flex-col gap-1.5">
                                            ...
                                            <input type="text" name="music_releases[<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>][desc]"
                                                value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['desc'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>"
                                        ...
                                        <div class="flex flex-col gap-1.5">
                                            ...
                                            <input type="url" name="music_releases[<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>][link]"
                                                value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['link'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>"
                            ...
                            <<i class="fa-solid fa-scissors"></i>php endforeach; <i class="fa-solid fa-scissors"></i>>
                        </div>
                ...
                <<i class="fa-solid fa-scissors"></i>php if (!empty($data['music']['releases'])): <i class="fa-solid fa-scissors"></i>>
                    <div class="mt-24 w-full pt-12 border-t-[8px] border-black border-dashed relative">
                        <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white px-6">
                            <span class="text-4xl"><i class="fa-solid fa-scissors"></i></span>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                            <<i class="fa-solid fa-scissors"></i>php foreach ($data['music']['releases'] as $index => $item): <i class="fa-solid fa-scissors"></i>>
                                <form method="POST" action="handler.php"
                                    onsubmit="return confirm('WARNING: Are you sure you want to permanently delete \'<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars(addslashes($item['title'] <i class="fa-solid fa-scissors"></i>: 'Item #' . ($index + 1))); <i class="fa-solid fa-scissors"></i>>\'<i class="fa-solid fa-scissors"></i>');"
                                    class="h-full">
                                    <input type="hidden" name="action" value="delete_music_item">
                                    <input type="hidden" name="delete_index" value="<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>">
                                    <button type="submit"
                                        ...
                                        <div class="flex flex-col gap-1.5 overflow-hidden pl-4 pr-2 relative z-10 w-[80%]">
                                            <span
                                                class="truncate w-full font-black text-lg group-hover:text-white break-all"><<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['title'] <i class="fa-solid fa-scissors"></i>: 'Unnamed Release'); <i class="fa-solid fa-scissors"></i>></span>
                                            <span
                                                ...
                                                #<<i class="fa-solid fa-scissors"></i>php echo $index + 1; <i class="fa-solid fa-scissors"></i>></span>
                                        </div>
                                        <span
            ...
            <!-- TAB: GALLERY -->
            <<i class="fa-solid fa-scissors"></i>php if ($tab === 'gallery'): <i class="fa-solid fa-scissors"></i>>
                <div
                    class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6 border-b-8 border-black border-dashed pb-8">
                    <div>
                ...
                <form action="handler.php" method="POST" enctype="multipart/form-data" class="space-y-10">
                    ...
                    <<i class="fa-solid fa-scissors"></i>php if (empty($data['gallery']['images'])): <i class="fa-solid fa-scissors"></i>>
                        <div
                    ...
                    <<i class="fa-solid fa-scissors"></i>php else: <i class="fa-solid fa-scissors"></i>>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 gap-y-14">
                            <<i class="fa-solid fa-scissors"></i>php foreach ($data['gallery']['images'] as $index => $item): <i class="fa-solid fa-scissors"></i>>
                                <div
                                    ...
                                    <div
                                        ...
                                        <span><i class="fa-solid fa-camera"></i></span> Frame #<<i class="fa-solid fa-scissors"></i>php echo $index + 1; <i class="fa-solid fa-scissors"></i>>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex-grow w-full overflow-hidden mt-2 xl:mt-0 pl-1">
                                            <label
                                                ...
                                                Source</label>
                                            <input type="hidden" name="gallery_images[<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>][existing_img]"
                                                value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['img'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>">
                                            <input type="file" name="gallery_img_<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>"
                                                class="w-full text-xs font-mono file:mr-3 file:py-1.5 file:px-3 file:border-2 file:border-black file:bg-[transparent] file:text-black file:hover:bg-black file:hover:text-white file:transition-colors file:font-bold file:uppercase cursor-pointer focus:outline-none truncate bg-white border-2 border-dashed border-gray-300 hover:border-black p-1 transition-colors">
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-col gap-5 mt-2">
                                        <div
                                            ...
                                            <label class="font-bold uppercase text-[10px] text-gray-400 tracking-widest">Photo
                                                Caption</label>
                                            <input type="text" name="gallery_images[<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>][caption]"
                                                value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['caption'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>"
                                        ...
                                        <div
                                            ...
                                            <input type="text" name="gallery_images[<<i class="fa-solid fa-scissors"></i>php echo $index; <i class="fa-solid fa-scissors"></i>>][classes]"
                                                value="<<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['classes'] <i class="fa-solid fa-burst"></i> ''); <i class="fa-solid fa-scissors"></i>>"
                ...
                <<i class="fa-solid fa-scissors"></i>php if (!empty($data['gallery']['images'])): <i class="fa-solid fa-scissors"></i>>
                    <div class="mt-24 w-full pt-12 border-t-[8px] border-black border-dashed relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                            <<i class="fa-solid fa-scissors"></i>php foreach ($data['gallery']['images'] as $index => $item): <i class="fa-solid fa-scissors"></i>>
                                <form method="POST" action="handler.php"
                                    onsubmit="return confirm('WARNING: Are you sure you want to permanently delete Frame #<<i class="fa-solid fa-scissors"></i>php echo $index + 1; <i class="fa-solid fa-scissors"></i>><i class="fa-solid fa-scissors"></i>');"
                                    class="h-full">
                                    ...
                                    <button type="submit"
                                        ...
                                        <div class="flex flex-col gap-1.5 overflow-hidden pl-4 pr-2 relative z-10 w-[80%]">
                                            <span
                                                class="truncate w-full font-black text-lg group-hover:text-white break-all"><<i class="fa-solid fa-scissors"></i>php echo htmlspecialchars($item['caption'] <i class="fa-solid fa-scissors"></i>: 'Unnamed Frame'); <i class="fa-solid fa-scissors"></i>></span>
                                            <span
                                                ...
                                                Photo #<<i class="fa-solid fa-scissors"></i>php echo $index + 1; <i class="fa-solid fa-scissors"></i>></span>
                                        </div>
                                        <span
                                            class="text-3xl group-hover:scale-125 group-hover:-rotate-12 transition-transform opacity-30 group-hover:opacity-100 flex-shrink-0 pr-2"><i class="fa-solid fa-burst"></i></span>
                                    </button>
                                </form>
                            <<i class="fa-solid fa-scissors"></i>php endforeach; <i class="fa-solid fa-scissors"></i>>
                        </div>
