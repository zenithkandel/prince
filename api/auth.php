...
function require_login()
{
    if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
        ...
        <body class="bg-gray-100 flex items-center justify-center h-screen font-sans px-4">
            <div class="bg-white p-6 sm:p-8 border-[4px] sm:border-[6px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full max-w-sm transform -rotate-1">
