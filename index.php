    ...
    <section id="gallery" class="relative w-full min-h-[150vh] py-24 flex flex-col items-center z-10">
      ...
      <!-- The Grid / Scatter Canvas -->
        <div class="relative w-full max-w-6xl h-full flex flex-wrap justify-center content-center gap-6 px-4 md:px-0">
          ...
          <div class="gallery-item polaroid bg-white p-3 md:p-4 pb-10 md:pb-12 border-[4px] border-ink cursor-grab hover:z-50 m-4 shadow-brutal-md transition-all duration-300 hover:scale-105 active:scale-95 <?php echo htmlspecialchars($photo['classes']); ?>"
